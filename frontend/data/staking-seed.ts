...
export const STAKING_SEED: StakingSeed[] = [
  ...
  { name: "Swell",          slug: "swell",       token: "swETH",   subSector: "Liquid Staking", secondaryTags: ["Non-Custodial"],                       llamaSlug: "swell-liquid-staking",        coingeckoId: "sweth",                       seedMode: "new" },
  ...
  { name: "Bedrock",        slug: "bedrock",     token: "uniETH",  subSector: "Liquid Restaking", secondaryTags: ["LST-Backed-Basket"],                 llamaSlug: "bedrock-unieth",              coingeckoId: "universal-eth",               seedMode: "new" },
